         ...
         <div class="texfield-group-">
            ...
            <div class="texfield">
               ...
               <input type="text"  id="emissor" name="emissor"
                  placeholder="digite o órgão emissor" required>
            </div>
            <div class="texfield">
               <label for="data_nascimento">  Nascimento:</label>
               <input type="date"  id="data_nascimento" name="data_nascimento"
                  placeholder="digite o seu niver" required>
            </div>
            </div>
            ...
            <div class="texfield">
               ...
               <textarea type="text" id="observacao" name="observacao"
                  placeholder=" Descrição do cargo" rows="3">
               </textarea>
            </div>
            <br>

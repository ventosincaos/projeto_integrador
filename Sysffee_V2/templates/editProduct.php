...
<div class='lado_direito'>
  ...
  <form id="create-form" action="<?=$BASE_URL?>/../config/processamentoProduto.php"
      method="POST">
    ...
    <div class="texfield-group-"> 
      <div class="texfield">
         ...
         <input type="text" id="nome" name="nome"
            placeholder="digite o nome" value="<?=$product['nome']?>" required>
      </div>
      <div class="texfield">
         <label for="nome">Código do Produto</label>
         <input type="text"  id="cod_product" name="cod_product"
            placeholder="digite o nome" value="<?=$product['cod_product']?>"required>
      </div>
      </div>

...
<tbody>
<?php foreach($Allfuncionario as $funcionario):?>
<tr>
...
<td> <!--Botão para visualizar dados--><a href="<?=$BASE_URL?>/show.php?id=<?=$funcionario["id"]?>"><ion-icon name="book-outline"></ion-icon></a></td>
